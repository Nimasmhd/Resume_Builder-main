...
const SignUp = ({ setCurrentPage, onClose }) => {
  ...
  return (
    <div className="w-[90vw] md:w-[450px] top-5 p-8 flex flex-col justify-center relative overflow-hidden max-h-[90vh] overflow-y-auto">
         <button
    type="button"
    onClick={onClose}
  ...
  >
    <svg className="w-5 h-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="absolute -top-24 -right-20 w-40 h-40 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full blur-3xl opacity-20 pointer-events-none z-0"></div>

      <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-gradient-to-br from-indigo-400 to-purple-400 rounded-full blur-3xl opacity-20 pointer-events-none z-0"></div>

      <div className="absolute top-1/2 right-0 w-32 h-32 bg-gradient-to-br from-pink-400 to-rose-400 rounded-full blur-3xl opacity-10 pointer-events-none z-0"></div>
      {/* Header */}
      ...
      <form onSubmit={handleSignUp} className="space-y-4 relative z-10">
        {/* Profile Photo Selector with enhanced styling */}
        <div className="flex justify-center mb-2">
          <div className="relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full opacity-30 blur group-hover:opacity-50 transition-opacity"></div>
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full relative group overflow-hidden px-6 py-4 rounded-xl font-semibold text-white transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/30 hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:translate-y-0 mt-2"
        >
      ...
      <div className="flex justify-center gap-1 mt-6">
        {[...Array(3)].map((_, i) => (
          <div
            key={i}
            className={`w-2 h-2 rounded-full ${i === 1 ? 'bg-gradient-to-r from-purple-600 to-pink-600' : 'bg-gray-200'}`}
          ></div>
        ))}
      </div>
    </div>
