...
const SignUp = ({ setCurrentPage }) => {
  ...
  return (
    <div className="w-[90vw] md:w-[450px] p-8 flex flex-col justify-center relative overflow-hidden max-h-[90vh] overflow-y-auto">
      ...
      <div className="absolute top-1/2 right-0 w-32 h-32 bg-gradient-to-br from-pink-400 to-rose-400 rounded-full blur-3xl opacity-10 pointer-events-none"></div>

      {/* Header */}
       
      {/* Header */}
      <div className="text-center mb-6 relative z-40 pt-4">
